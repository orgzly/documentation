...
:END:
 ...
 The Dropbox app is not required for syncing, instead you will
 allow Orgzly to contact Dropbox on your behalf.   
 However, you have to specify a directory for storing your notebooks or 
 syncing will fail:
 ...
 - Enter the directory inside Dropbox (without "Dropbox" part, but starting
   with ~/~)
